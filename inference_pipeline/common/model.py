...
class AttModel(nn.Module):
    """
    This is an audio classification model for training.\n
    It is hard to JIT compile this model because of the dynamic nature of the model.\n
    So, to use this model for inference with Torchscript or convert to ONNX for other purposes,
    please use InferenceAttModel instead.
    """
    def __init__(
        self,
        backbone="resnet34",
...
class InferenceAttModel(nn.Module):
    """
    Audio classification model for inference.\n
    It does not have modules and operations that support training.
    It also does not have preprocessing steps inside the model.\n
    Use it only for inference with the preprocessed input.
    """
    def __init__(
        self,
        backbone="resnet34",
