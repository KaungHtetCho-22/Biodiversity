...
# Data #
######################
cfg.train_audio_dir = "./data/sounds_original/"
...
cfg.target_columns = [
    ...
    'Culicicapa-ceylonensis', 'Ixos-mcclellandii', 'Picumnus-innominatus', 
    ...
    "Phaneroptera-nana",  
    "Platypleura-cfcatenata",  
    "Platypleura-plumosa",  
    "Platypleura-sp10",  
    "Platypleura-sp12cfhirtipennis",  
    "Platypleura-sp13",  
    "Ruspolia-nitidula",

]

print(f'target columns: {len(cfg.target_columns)}')
